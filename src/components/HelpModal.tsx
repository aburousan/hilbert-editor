...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Export', where: 'File → Save As / Export', desc: 'PDF (with PDF/A standards, tagging, page ranges), PNG, SVG, HTML, plain .typ, or the whole project folder — through the native save dialog, with “open when done”.' },
